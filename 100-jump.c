...
{
printf("Value checked array[%d] = [%d] ", section_end, array[section_end]);
...
printf("Value found between indexes [%d] and [%d] ", start, section_end);
...
{
printf("Value checked array[%d] = [%d] ", start, array[start]);
