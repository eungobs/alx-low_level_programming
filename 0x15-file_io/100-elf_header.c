 ...
 * @e_ident: points to an array containing the ELF magic nos
 *
 ...
 * @e_type: The ELF type.
 * @e_ident: points to array containing the ELF.
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
{
 ...
 * @e_entry: is address of the ELF entry point.
 * @e_ident: points to an array containing the ELF class.
 */
void print_entry(unsigned long int e_entry, unsigned char *e_ident)
{
 ...
 *              the function fails - 98 (exit code)
 */
